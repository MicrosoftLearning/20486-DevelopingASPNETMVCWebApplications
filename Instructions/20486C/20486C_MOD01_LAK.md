...
2. On the **FILE** menu of the **Start Page – Microsoft Visual Studio** window, point to **Open**, and then click **Project/Solution**. 
3. In the **Open Project** dialog box, navigate to **Allfiles/20486C/Mod01/Labfiles/PhotoSharingSample**, click **PhotoSharingSample.sln**, and then click **Open**.
4. On the **DEBUG** menu of the **PhotoSharingSample – Microsoft Visual Studio** window, click **Start Without Debugging**.
5. On the **Home** page of the **http://localhost:[port]/** window, in the upper-right corner, click **Register**.
...
4. Expand **Web**, and then click **Web Site**.
...
1. In the Solution Explorer pane of the **WebSite1(1) - Microsoft Visual Studio** window, double-click **Web.config**.
...
4. In the Solution Explorer pane of the **WebSite1(1) - Microsoft Visual Studio** window, dobule-click **Default.cshtml**.
...
9. In the Solution Explorer pane, double-click **_SiteLayout.cshtml**.
...
1. In the Solution Explorer pane of the **WebSite1(1) - Microsoft Visual Studio** window, double-click **TestPage.cshtml**.
...
1. In the Solution Explorer pane of the **TestWebFormsApplication – Microsoft Visual Studio** window, double-click **Default.aspx**.
2. In the first line of the Default.aspx code window, note that the value of the **MasterPageFile** attribute is **~/Site.Master**.
3. In the Solution Explorer pane, double-click **Contact.aspx**.
...
6. In the Solution Explorer pane of the **TestWebFormsApplication – Microsoft Visual Studio** window, dobule-click **Site.Master**.
7. In the Site.Master code window, note that the path for **BundleReference** is **~/Content/css**.
8. In the Solution Explorer pane, double-click **Bundle.config**.
9. In the Bundle.config code window, note that there are links to files with a .css extension.
10. In the Solution Explorer pane, expand **Content**, and then double-click **Site.css**.
...
5. In the Solution Explorer pane of the **TestWebFormsApplication – Microsoft Visual Studio** window, dobule-click **Default.aspx**.
...
1. In the Solution Explorer pane of the **TestWebFormsApplication – Microsoft Visual Studio** window, double-click **TestPage.aspx**.
